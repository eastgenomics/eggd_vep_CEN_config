...
| **TWE_varstore** | - | 260115_variant_store_GRCh38_WES_v1.vcf.gz |
| **CEN_varstore** | - | 260115_variant_store_GRCh38_CEN_v1.vcf.gz |
...
| **Prev_Interpret (i.e. Inca)** | - | 260304_inca_germline_GRCh38.vcf.gz |
